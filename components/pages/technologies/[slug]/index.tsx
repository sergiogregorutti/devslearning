        ...
        <div className="bg-white rounded-xl p-4 border border-neutral-200">
          ...
          {lang === "en" ? (
            ...
            <>
              ...
              <p className="mb-3">
                ¡Te tenemos cubierto! Hemos seleccionado cuidadosamente los
                cursos de {technology.name} más populares, tanto gratuitos como
                de pago. ¡Así que puedes empezar a aprender de inmediato!
              </p>
              <Button
