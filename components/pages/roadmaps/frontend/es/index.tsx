      ...
      <Container className="pb-10">
        <div className="bg-white rounded-xl p-4 border border-neutral-200">
          ...
          <p className="mb-6 leading-[30px]">
            HTML es la columna vertebral del desarrollo web. Aprende a
            estructurar tu contenido utilizando HTML y a estilizarlo con CSS
            para crear sitios web visualmente atractivos. Domina conceptos como
            el Modelo de Caja, Flexbox, Grid y diseño responsive para asegurarte
            de que tu sitio funcione en todos los dispositivos.
          </p>
          ...
          <p className="mb-6 leading-[30px]">
            ...
            los tamaños de pantalla. Aprende a usar media queries, layouts
            fluidos y diseño mobile-first para crear interfaces web flexibles y
            fáciles de usar.
          </p>
          ...
          <p className="mb-6 leading-[30px]">
            ...
            reutilizables, gestionar el estado y usar hooks para un desarrollo
            más eficiente y mejor rendimiento.
          </p>
          ...
          />
          <p className="mb-6 leading-[30px]">
            Webpack y Babel son esenciales para empaquetar y transpilar tu
            código. Comprende cómo configurar estas herramientas para optimizar
            el rendimiento y garantizar la compatibilidad entre navegadores.
          </p>
          ...
          <p className="mb-6 leading-[30px]">
            ...
            modernas como Netlify y Vercel. Domina el proceso de llevar tu
            código a producción con pipelines de Continuous Deployment (CD) y
