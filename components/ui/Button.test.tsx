...
describe("Button Component", () => {
  ...
  test("button is disabled when disabled prop is true", () => {
    ...
    expect(button).toHaveClass(
      "rounded-full transition-all duration-500 focus:outline-none text-center inline-block bg-neutral-100 text-neutral-400 hover:bg-neutral-100 cursor-default text-lg py-[9px] px-[28px]"
    );
