...
export default function Language({
  ...
  const handleChange = () => {
    const english = (document.getElementById('languageEn') as HTMLInputElement)?.checked;
    const spanish = (document.getElementById('languageEs') as HTMLInputElement)?.checked;
